...
const basePropertySummaries: PropertySummary[] = [
  {
    property: {
      ...
      description: 'Ubicada en el corazón de Puerto Madero, esta residencia ofrece ventanales piso-techo, domótica completa, cocina gourmet con isla de mármol italiano y una terraza verde con parrilla. El edificio cuenta con certificación LEED y concierge 24/7.',
      descriptionEn: 'Located in the heart of Puerto Madero, this residence offers floor-to-ceiling windows, full smart home automation, a gourmet kitchen with Italian marble island and a green terrace with grill. The building has LEED certification and 24/7 concierge.',
      price: 3200,
      salePrice: 850000,
      currency: 'USD',
  ...
  },
  {
    property: {
      id: 5,
      title: 'Córdoba Smart Flat',
      subtitle: 'Departamento inteligente con patio andaluz',
      description: 'Un dos ambientes amplio con patio interno estilo andaluz, luz natural todo el día y sensores inteligentes que automatizan iluminación y climatización. Ideal para nómadas digitales.',
      price: 980,
      salePrice: 260000,
      currency: 'USD',
  ...
  },
  {
    property: {
      id: 15,
      title: 'Buenos Aires Coliving Capsule',
  ...
  },
  {
    property: {
      id: 39,
      title: 'Buenos Aires Recoleta Duplex',
      subtitle: 'Dúplex histórico en Recoleta',
      description: 'Dúplex restaurado en edificio histórico de Recoleta. Incluye balcón francés, techos altos decorados y ubicación privilegiada cerca de cementerio y museos.',
      price: 2900,
      salePrice: 780000,
      currency: 'USD',
...
const syntheticLocations: SyntheticLocation[] = [
  { location: 'Palermo Soho, Buenos Aires', city: 'Buenos Aires', country: 'Argentina', neighborhood: 'Palermo Soho', type: 'Apartamento boutique', currency: 'USD', latitude: -34.5805, longitude: -58.4233 },
...
const SEARCH_SYNONYMS: Record<string, string[]> = {
  ...
  puer: ['puerto'],
  madero: ['puerto madero', 'puerto'],
  palermo: ['palermo soho', 'palermo hollywood', 'palermo viejo'],
  recoleta: ['recoleta'],
